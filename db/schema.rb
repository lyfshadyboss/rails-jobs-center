...
ActiveRecord::Schema.define(version: 20140502041509) do
  ...
  add_index "delivers", ["post_id"], name: "index_delivers_on_post_id"
  add_index "delivers", ["resume_id"], name: "index_delivers_on_resume_id"
